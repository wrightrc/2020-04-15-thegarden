...
venue: "Clay's backyard"        # brief name of host site without address (e.g., "Euphoric State University")
address: "somewhere"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
